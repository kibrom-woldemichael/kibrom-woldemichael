...
- Wrote SQL queries to analyze revenue, profit, and customer performance
- Used SQLite to explore business insights from structured data

-> https://github.com/kibrom-woldemichael/coffee-sql-analysis
